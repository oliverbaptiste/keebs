...
---
# Keebio _Quefrency Rev. 4_ 60% keyboard

A split staggered QWERTY keyboard layout</strong> for macOS, inspired by [HHKB](https://hhkb.io/layout/) and [SpaceFn](https://geekhack.org/index.php?topic=51069.0) layouts.
...
## Version 1: 61-key layout

![Keebio Quefrency Rev. 4 keyboard - 61-key layout with Drop + biip MT3 Extended 2048 keycaps](images/keebio-quefrency-rev4-hhkb.jpg)

![Keebio Quefrency Rev. 4 - HHKB layout](images/keebio-quefrency-rev4-hhkb.png)

KLE layout: <http://www.keyboard-layout-editor.com/#/gists/69eaf79c79cee5e88ad23d3aa2c4c905>

-----

## Version 2: 65-key layout

![Quefrency &times; SA DUALSHOT](images/quefrencyXdualshot.png)

### 2025 Update

This board eventually succumbed to the bottom of a project drawer in lieu of other keyboards: particularly my Keychron V8.
...
* Influenced by the <strong>Happy Hacking Keyboard</strong>:
  * 61-key layout:
